...
public class HandlingShadowDom {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://dev125701.service-now.com/");
		...
		shadow.findElementByXPath("//input[@id='sncwsgs-typeahead-input']").sendKeys("Incident");
		
		WebElement eleFrame = shadow.findElementByXPath("//iframe[@id='gsft_main']");
		
		driver.switchTo().frame(eleFrame);
		
		boolean displayed = shadow.findElementByXPath("//div[text()='Build apps fast.']").isDisplayed();
